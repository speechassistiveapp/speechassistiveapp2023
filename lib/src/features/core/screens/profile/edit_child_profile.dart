  ...
  class EditChildProfileModal extends StatefulWidget {
    @override
    _EditChildProfileModalState createState() => _EditChildProfileModalState();
  }

  class _EditChildProfileModalState extends State<EditChildProfileModal> {
  ...
  Future<void> _uploadImage(File imageFile) async {
    ...
    try {
      ...
      prefs.setString('cAvatar', imageName);
  ...
  prefs.setString('cName', fullName); // Save the email to preferences
      ...
      if (_selectedGender!.isNotEmpty) {
        await userRef.update({
          'childUser': '{"FullName":"$fullName","Gender":"$_selectedGender","Avatar":"$cAvatar"}',
        });
        
      prefs.setString('cGender', _selectedGender!); // Save the email to preferences
        _showSnackBar('Data updated successfully!');
        _closeEditChildProfileModal();
      }else{
        await userRef.update({
          'childUser': '{"FullName":"$fullName","Gender":"$cGender","Avatar":"$cAvatar"}',
        });
  ...
  prefs.setString('cName', fullName); // Save the email to preferences
      ...
      if (_selectedGender!.isNotEmpty) {
        await userRef.update({
          'childUser': '{"FullName":"$cName","Gender":"$_selectedGender","Avatar":"$cAvatar"}',
        });
      ...
      prefs.setString('cGender', _selectedGender!); // Save the email to preferences
        ...
        await userRef.update({
          'childUser': '{"FullName":"$cName","Gender":"$cGender","Avatar":"$cAvatar"}',
        });
...
void _closeEditChildProfileModal() {
    ...
    Widget build(BuildContext context) {
      return Container(
        ...
        child: Column(
          ...
          children: [
            Text(
              'Tap the Avatar icon to change your child profile picture',
