...
void _showImageModal(String imagePath, String houseName, List<String> words, List<String> emojiForWords) {
  showDialog(
    context: context,
          ...
          children: [
            ...
            GestureDetector(
              ...
              : () async {
                  ...
                  playTextToSpeechChild('${houseName}', cGender!);
                },
               child: CachedNetworkImage(
                imageUrl: 'https://speech-assistive-app.com/assets/images/home/${houseName.toLowerCase()}.png',
                fit: BoxFit.cover,
                    ...
                    if (snapshot.connectionState == ConnectionState.waiting) {
                      ...
                      return GridView.count(
                        ...
                        children: itemList.asMap().entries.map((entry) {
                          ...
                          final String houseName = item['_homeNames'];
                          final String description = item['_wordsForHome'];
                          final String emoji1 = item['_emojiWords'];
                          final String emoji2 = item['_emojiWords'];

                          final List<String> wordsForColor = [houseName, description];
                          final List<String> emojiForWords = [emoji1, emoji2];

                          final String imagePath =
                              'https://speech-assistive-app.com/assets/images/home/${houseName.toLowerCase()}.png';


                          return GestureDetector(
                            onTap: () => _showImageModal(itemImagePath, houseName, wordsForColor, emojiForWords),
                            child: Card(
